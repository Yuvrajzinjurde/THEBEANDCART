    ...
    return (
        <section className="py-12 container px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 sm:grid-rows-4 gap-4 max-w-3xl mx-auto">
                ...
                <div className="relative rounded-xl overflow-hidden shadow-lg p-6 flex flex-col items-center justify-center text-center row-span-2 bg-secondary/70 backdrop-blur-sm">
...
const ProductCarouselSection = ({ title, products, brandName, emoji }: { title: string, products: IProduct[], brandName: string, emoji?: string }) => {
