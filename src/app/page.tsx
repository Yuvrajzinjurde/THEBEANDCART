...
export default function LandingPage() {
  ...
  // For now, let's assume we want to show category banners for the first brand.
  // In a multi-tenant platform, you might have a different logic to select which brand's categories to show.
  const featuredBrand = brands.length > 0 ? brands.find(b => b.permanentName === 'reeva') || brands[0] : null;
  ...
  return (
    ...
    <main className="flex-1 flex flex-col items-center bg-background">
        ...
        <CategoryBannerGrid brand={featuredBrand} />
